<div class="min-h-screen bg-gray-50">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:py-6 gap-4">
            ...
            <div class="flex items-center space-x-3 sm:space-x-4 flex-shrink-0">
                ...
                <div class="flex items-center">
                    @if(isset($hasClockedIn) && $hasClockedIn)
                        <div class="bg-green-100 border border-green-200 text-green-700 px-3 py-2 rounded-lg text-sm font-semibold flex items-center shadow-sm">
                    ...
                    @else
                        <div class="bg-amber-100 border border-amber-200 text-amber-800 px-3 py-2 rounded-lg text-sm font-semibold flex items-center shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <h1>HALO INI TES 123 (MUNCUL GAK?)</h1>
        <!-- Project Stats Overview (Always visible) -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- [BARU] Widget Status Absensi -->
            <div class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
                <div class="flex items-center">
                    @if(isset($hasClockedIn) && $hasClockedIn)
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Status Absen</p>
                            <p class="text-lg font-bold text-green-600">Sudah Absen</p>
                        </div>
                    @else
                        <!-- Jika BELUM Absen -->
                        <div class="p-2 bg-yellow-50 rounded-lg animate-pulse">
